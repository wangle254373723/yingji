...
namespace VRCapture {
    ...
    /// </summary>
    public class VRUIGraphicRaycaster : GraphicRaycaster {
        ...
        [NonSerialized]
        private List<VRGraphic> vrRaycastResults = new List<VRGraphic>();
        [NonSerialized]
        private static readonly List<VRGraphic> sortedGraphics = new List<VRGraphic>();
        ...
        public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList) {
            ...
            Raycast(Canvases, eventCamera, ray, vrRaycastResults);
        ...
        private void SetNearestRaycast(ref PointerEventData eventData, List<RaycastResult> resultAppendList) {
            ...
            for (var index = 0; index < vrRaycastResults.Count; index++) {
                ...
                castResult.sortingLayer = Canvases.sortingLayerID;
                castResult.sortingOrder = Canvases.sortingOrder;
        ...
        private float GetHitDistance(Ray ray) {
            ...
            if (Canvases.renderMode != RenderMode.ScreenSpaceOverlay && blockingObjects != BlockingObjects.None) {
                var maxDistance = Vector3.Distance(ray.origin, Canvases.transform.position);
        ...
        private Canvas Canvases {
            get {
                ...
                canvases = gameObject.GetComponent<Canvas>();
                return canvases;
            }
        }
    }
